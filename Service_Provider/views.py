...
def likes_chart(request):
    # Generate your graph data here. This is just an example.
    graph_data = {
    ...
    return render(request, 'likeschart.html', context)
...
def train_model(request):
    ...
    labeled = 'sentiment_analysis.csv'
